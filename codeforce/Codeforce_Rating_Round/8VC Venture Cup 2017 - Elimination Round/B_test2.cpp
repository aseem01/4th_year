...
#define Inter(v, a, n, b, m) v.resize(set_intersection(a, a + 👎, b, b + (m), v.begin()) - v.begin())
#define SInter(v, a, n, b, m) v.resize((n) + (m)); sort(a, a + (n)); sort(b, b + (m)); Inter(v, a, n, b, m)
#define Union(v, a, n, b, m) v.resize(set_union(a, a + 👎, b, b + (m), v.begin()) - v.begin());
#define SUnion(v, a, n, b, m) v.resize((n) + (m)); sort(a, a + (n)); sort(b, b + (m)); Union(v, a, n, b, m)
#define Diff(v, a, n, b, m) v.resize(set_difference(a, a + 👎, b, b + (m), v.begin()) - v.begin())
#define SDiff(v, a, n, b, m) v.resize((n) + (m)); sort(a, a + (n)); sort(b, b + (m)); Diff(v, a, n, b, m)
#define Sym(v, a, n, b, m) v.resize(set_symmetric_difference(a, a + 👎, b, b + (m) v.begin()) - v.begin())
...
#define SIIIII(a, b, c, d, e) scanf("%I64d%I64d%I64d%I64d%I64d", &a, &b, &c, &d, &e)
...
#define PA(a, i, n) For(i, 👎 - 1) printf("%d ", a[i]); PI(a[(n) - 1])
...
#define Accv(a, n) (accumulate(a.begin(), a.begin() + 👎, 0))
#define AaddB(a, n, b) transform(a, a + 👎, b, a, plus<int>())
...
#define Lowpos(a, n, x) (lower_bound(a, a + 👎, x) - (a))
#define Upppos(a, n, x) (upper_bound(a, a + 👎, x) - (a))
#define BS(a, n, x) binary_search(a, a + 👎, x)
#define Range(a, n, x) equal_range(a, a + 👎, x)
#define Fpos(a, n, x) (find(a, a + 👎, x) - (a))
